...
exports.WatchResourcesService = new runtime_rpc_1.ServiceType("authzed.api.v1alpha1.WatchResourcesService", [
    { name: "WatchResources", serverStreaming: true, options: { "google.api.http": { post: "/v1alpha1/lookupwatch", body: "*" } }, I: exports.WatchResourcesRequest, O: exports.WatchResourcesResponse }
]);
