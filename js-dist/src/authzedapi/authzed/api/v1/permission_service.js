...
class ReadRelationshipsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("authzed.api.v1.ReadRelationshipsResponse", [
            { no: 1, name: "read_at", kind: "message", T: () => core_6.ZedToken, options: { "validate.rules": { message: { required: true } } } },
            { no: 2, name: "relationship", kind: "message", T: () => core_5.Relationship, options: { "validate.rules": { message: { required: true } } } }
        ]);
    }
    create(value) {
        const message = {};
...
class CheckPermissionResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("authzed.api.v1.CheckPermissionResponse", [
            { no: 1, name: "checked_at", kind: "message", T: () => core_6.ZedToken, options: { "validate.rules": { message: { required: false } } } },
            ...
            { no: 3, name: "partial_caveat_info", kind: "message", T: () => exports.PartialCaveatInfo, options: { "validate.rules": { message: { required: false } } } }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* authzed.api.v1.PartialCaveatInfo partial_caveat_info */ 3:
                    message.partialCaveatInfo = exports.PartialCaveatInfo.internalBinaryRead(reader, reader.uint32(), options, message.partialCaveatInfo);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.partialCaveatInfo)
            exports.PartialCaveatInfo.internalBinaryWrite(message.partialCaveatInfo, writer.tag(3, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class LookupResourcesResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("authzed.api.v1.LookupResourcesResponse", [
            ...
            { no: 4, name: "partial_caveat_info", kind: "message", T: () => exports.PartialCaveatInfo, options: { "validate.rules": { message: { required: false } } } }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.partialCaveatInfo)
            exports.PartialCaveatInfo.internalBinaryWrite(message.partialCaveatInfo, writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class LookupSubjectsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("authzed.api.v1.LookupSubjectsResponse", [
            ...
            { no: 5, name: "partial_caveat_info", kind: "message", T: () => exports.PartialCaveatInfo, options: { "validate.rules": { message: { required: false } } } },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.partialCaveatInfo)
            exports.PartialCaveatInfo.internalBinaryWrite(message.partialCaveatInfo, writer.tag(5, runtime_1.WireType.LengthDelimited).fork(), options).join();
