...
export const SchemaService = new ServiceType("authzed.api.v1.SchemaService", [
    { name: "ReadSchema", options: { "google.api.http": { body: "*", post: "/v1/schema/read" } }, I: ReadSchemaRequest, O: ReadSchemaResponse },
    { name: "WriteSchema", options: { "google.api.http": { body: "*", post: "/v1/schema/write" } }, I: WriteSchemaRequest, O: WriteSchemaResponse }
]);
