...
class ReadConfigRequest$Type extends MessageType<ReadConfigRequest> {
    constructor() {
        super("authzed.api.v0.ReadConfigRequest", [
            { no: 1, name: "namespace", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { maxBytes: "128", pattern: "^([a-z][a-z0-9_]{1,62}[a-z0-9]/)?[a-z][a-z0-9_]{1,62}[a-z0-9]$" } } } },
...
class DeleteConfigsRequest$Type extends MessageType<DeleteConfigsRequest> {
    constructor() {
        super("authzed.api.v0.DeleteConfigsRequest", [
            { no: 1, name: "namespaces", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { repeated: { minItems: "1", items: { string: { maxBytes: "128", pattern: "^([a-z][a-z0-9_]{1,62}[a-z0-9]/)?[a-z][a-z0-9_]{1,62}[a-z0-9]$" } } } } } }
        ]);
    }
